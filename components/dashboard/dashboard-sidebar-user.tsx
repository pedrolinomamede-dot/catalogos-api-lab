...
export function DashboardSidebarUser() {
  return (
    <div className="space-y-4">
      <div className="rounded-[24px] border border-[var(--dashboard-sidebar-border)] bg-white/6 px-4 py-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.06)]">
      ...
      <div className="space-y-3 rounded-[24px] border border-[var(--dashboard-sidebar-border)] bg-white/5 px-4 py-4">
