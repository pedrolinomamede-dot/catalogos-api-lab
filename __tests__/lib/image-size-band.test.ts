...
describe("image size band", () => {
  it("classifies small products up to 100", () => {
    ...
    expect(resolveProductImageScale("100ml")).toBe(0.6);
  });
  ...
  it("classifies medium products from 100 to 500", () => {
    ...
    expect(resolveProductImageScale("250ml")).toBe(0.8);
  });
